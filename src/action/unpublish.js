...
export async function unpublish(book, params) {
    ...
    await page.waitForSelector(id, { timeout: Timeouts.SEC_10 });
    await page.focus(id);
    await page.click(id, { timeout: Timeouts.SEC_2 });
    ...
    await page.waitForSelector(id, { timeout: Timeouts.SEC_10 });
    await page.focus(id, { timeout: Timeouts.SEC_10 });
    try {
