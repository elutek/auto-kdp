...
export async function isMetadataUpdateNeeded(book: Book, params: ActionParams): Promise<ActionResult> {
  ...
  // Title.
  const title = await page.$eval('#data-print-book-title', x => (x as HTMLInputElement).value)
  ...
  // Subtitle
  const subtitle = await page.$eval('#data-print-book-subtitle', x => (x as HTMLInputElement).value)
  ...
  // Series title.
  const seriesTitle = (await page.$eval('#series_title', x => (x as HTMLInputElement).value)) || '';
  ...
  // Author first name.
  const authorFirstName = await page.$eval('#data-print-book-primary-author-first-name', x => (x as HTMLInputElement).value);
  ...
  // Author last name.
  const authorLastName = await page.$eval('#data-print-book-primary-author-last-name', x => (x as HTMLInputElement).value);
  ...
  const illustratorFirstName = await page.$eval('#data-print-book-contributors-0-first-name', x => (x as HTMLInputElement).value);
  ...
  const illustratorLastName = await page.$eval('#data-print-book-contributors-0-last-name', x => (x as HTMLInputElement).value);
  ...
  const illustratorRole = await page.$eval('#data-print-book-contributors-0-role-native', x => (x as HTMLInputElement).value);
  ...
  const description = await page.$eval('#cke_1_contents > textarea', x => (x as HTMLTextAreaElement).value);
  ...
  // Keywords
  const keyword0 = await page.$eval('#data-print-book-keywords-0', x => (x as HTMLInputElement).value);
  ...
  const keyword1 = await page.$eval('#data-print-book-keywords-1', x => (x as HTMLInputElement).value);
  ...
  const keyword2 = await page.$eval('#data-print-book-keywords-2', x => (x as HTMLInputElement).value);
  ...
  const keyword3 = await page.$eval('#data-print-book-keywords-3', x => (x as HTMLInputElement).value);
  ...
  const keyword4 = await page.$eval('#data-print-book-keywords-4', x => (x as HTMLInputElement).value);
  ...
  const keyword5 = await page.$eval('#data-print-book-keywords-5', x => (x as HTMLInputElement).value);
  ...
  const keyword6 = await page.$eval('#data-print-book-keywords-6', x => (x as HTMLInputElement).value);
  ...
  const category1 = (await page.$eval('#data-print-book-categories-1-bisac', x => (x as HTMLInputElement).value)) || '';
  const category2 = (await page.$eval('#data-print-book-categories-2-bisac', x => (x as HTMLInputElement).value)) || '';
